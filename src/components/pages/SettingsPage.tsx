    ...
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: 600 }}>
        <div style={{ background: "#121830", border: "1px solid #232C52", borderRadius: 14, padding: 28 }}>
          <h3 style={{ color: "#F3F5FF", fontSize: 18, fontWeight: 600, margin: "0 0 20px" }}>Perfil</h3>
          ...
          <button
            onClick={handleSave}
            style={{ padding: "12px 24px", background: saved ? "#3FCB92" : "linear-gradient(90deg,#22B07D,#3FCB92)", color: "#080B14", border: "none", borderRadius: 10, fontSize: 15, fontWeight: 700, cursor: "pointer" }}
          >
