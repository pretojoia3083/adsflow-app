    ...
    const ads = (data.data || [])
      .map((ad: any) => {
        ...
        return {
          ...
          snapshotUrl: ad.ad_creative_link_urls?.[0] || ad.ad_snapshot_url || "",
          pageUrl: ad.ad_creative_link_urls?.[0] || (ad.page_id ? `https://www.facebook.com/${ad.page_id}` : ""),
