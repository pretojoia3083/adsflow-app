...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        setError("Conta criada, mas houve erro ao fazer login");
      } else {
      ...
      <div style={{ width: "100%", maxWidth: 480 }}>
        <div style={{ textAlign: "center", marginBottom: 44 }}>
          ...
          <p style={{ color: "#8C93B8", marginTop: 16, fontSize: 16 }}>
            Crie sua conta e comece a criar campanhas
          </p>
        </div>
        ...
        <p style={{ textAlign: "center", marginTop: 28, color: "#8C93B8", fontSize: 16 }}>
          Ja tem conta?{" "}
          <Link href="/login" style={{ color: "#22B07D", fontWeight: 600, textDecoration: "none" }}>
            Entrar
          </Link>
        </p>
      </div>
